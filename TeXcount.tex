...
\option{Exclude all}[-4]{xall}
 Ignore all, including unbalanced braces (used by \code{\%TC:ignore} and the \code{verbatim} environment).
\end{description}
